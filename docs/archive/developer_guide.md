...
## <span style="color:#b80202">THIS DOCUMENT HAS BEEN DEPRECATED - it has been replaced by the following documents:</span>
- [docs/workloads/guides/workload_setup.md](../workloads/guides/workload_setup.md)
- [docs/workloads/guides/workload_usage.md](../workloads/guides/workload_usage.md)
- [docs/workloads/guides/workload_usage_android.md](../workloads/guides/workload_usage_android.md)
- [docs/workloads/guides/android_labs.md](../workloads/guides/android_labs.md)
